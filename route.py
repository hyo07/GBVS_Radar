...
def index():
    ...
    chara_dic = {
        ...
        "シャル": {"checked": False, "character": "シャル", "name": "シャルロッテ"},
        "ランス": {"checked": False, "character": "ランス", "name": "ランスロット"},
        "パー": {"checked": False, "character": "パー", "name": "パーシヴァル"},
        ...
        "ソリッズ": {"checked": False, "character": "ソリッズ", "name": "ソリッズ"},
        "ジータ": {"checked": False, "character": "ジータ", "name": "ジータ"},
        ...
        "ウーノ": {"checked": False, "character": "ウーノ", "name": "ウーノ"},
    }
